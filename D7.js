...
const numeriRandom = function () {
  let contenitoreBello = []
  for (let i = 0; i < 10; i++) {
    contenitoreBello.push(Math.floor(Math.random() * 101))
  }
  return contenitoreBello
}
...
*/
let arrayCoso = [10, 25, 22, 11, 60]
const fortuna = arrayCoso.filter((num) => num % 2 === 0)
